...
results["RAM"] = results["bytes"].apply(lambda x: "{:.2f}GB".format(x/1e9))
...
# %%
pretty_results = results[["width","height", "#positions", "comp.time", "GC perc.", "RAM", "#allocatable", "perc. allocated"]]
